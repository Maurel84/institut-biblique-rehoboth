...
export function Modal({
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto p-4 flex justify-center items-start">
      ...
      <div className={`relative bg-white rounded-xl shadow-xl w-full ${sizes[size]} my-auto max-h-[90vh] md:max-h-[85vh] overflow-hidden flex flex-col animate-scale-in`}>
